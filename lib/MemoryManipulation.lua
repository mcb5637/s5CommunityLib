...
MemoryManipulation.ObjFieldInfo = {
	...
	[MemoryManipulation.ClassVTable.GGL_CLogicProperties] = {
		...
		fields = {
			...
			{name="BuildingUnderConstructionExplorationFactor", index={22}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="BuildingPlacementSnapDistance", index={23}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="BuildingClosedHealthFactor", index={24}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="WeatherExplorationBuildingSnowFactor", index={25}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="WeatherExplorationSettlerSnowFactor", index={26}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="WeatherMoveSpeedSnowFactor", index={27}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="WeatherExplorationBuildingRainFactor", index={28}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="WeatherExplorationSettlerRainFactor", index={29}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="WeatherMoveSpeedRainFactor", index={30}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="WeatherMissChanceChangeRain", index={31}, datatype=MemoryManipulation.DataType.Int, check=function(a) return a>=0 end},
			{name="WeatherMissChanceChangeSnow", index={32}, datatype=MemoryManipulation.DataType.Int, check=function(a) return a>=0 end},
			{name="AttackMoveRange", index={33}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="BlessingBonus", index={55}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="ResourceDoodadWarnAmount", index={59}, datatype=MemoryManipulation.DataType.Int, check=function(a) return a>=0 end},
			{name="MotivationThresholdHappy", index={69}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="MotivationThresholdSad", index={70}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			...
			{name="ExpelEffectID", index={89}, datatype=MemoryManipulation.DataType.Int, check=GGL_Effects},
			{name="DefenderMSPerShot", index={90}, datatype=MemoryManipulation.DataType.Int, check=function(a) return a>=0 end},
			{name="DefenderMaxRange", index={91}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="DefenderProjectileDamage", index={93}, datatype=MemoryManipulation.DataType.Int, check=function(a) return a>=0 end},
			{name="DefenderMissChance", index={95}, datatype=MemoryManipulation.DataType.Int, check=function(a) return a>=0 end},
			{name="EnergyRequiredForWeatherChange", index={99}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
			{name="MaxFaith", index={103}, datatype=MemoryManipulation.DataType.Float, check=function(a) return a>=0 end},
		},
	},
